  ...
  return (
    <div style={{ width: '100%', height: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ 
        ...
        <h1 style={{ margin: 0, fontSize: '24px' }}>Railway Controller Dashboard</h1>
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center' }}>
          <div style={{ fontSize: '24px', fontWeight: 'bold', color: '#1f3a93' }}>5</div>
          <div style={{ fontSize: '14px', color: '#666' }}>Active Trains</div>
        </div>
        <div style={{ textAlign: 'center' }}>
          <div style={{ fontSize: '24px', fontWeight: 'bold', color: '#0bda51' }}>2</div>
          <div style={{ fontSize: '14px', color: '#666' }}>On Schedule</div>
        </div>
        <div style={{ textAlign: 'center' }}>
          <div style={{ fontSize: '24px', fontWeight: 'bold', color: '#ff4d4d' }}>1</div>
          <div style={{ fontSize: '14px', color: '#666' }}>Delayed</div>
        </div>
        <div style={{ textAlign: 'center' }}>
          <div style={{ fontSize: '24px', fontWeight: 'bold', color: '#ff8c00' }}>2</div>
          <div style={{ fontSize: '14px', color: '#666' }}>Rerouted</div>
        </div>
      </div>
    </div>
  );
